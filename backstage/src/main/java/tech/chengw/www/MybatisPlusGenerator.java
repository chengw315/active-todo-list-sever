...
public class MybatisPlusGenerator {
    ...
    private static final String SERVICE_PACKAGE = "service.iService";
    private static final String SERVICE_IMPL_PACKAGE = "service";
    private static final String POJO_PACKAGE = "entity.po";
    private static final String CONTROLLER_PACKAGE = "web.gen";
    ...
    public static void main(String[] args) {
        ...
        DATA_URL = "jdbc:mysql://106.15.251.107:3306/todolist?useUnicode=true&characterEncoding=utf8";
        DATA_NAME = "root";
        DATA_PWD = "Chengw315";
        TABLE_NAMES = new String[]{"task","subtask","script_customize","script","script_open_file","script_open_web"};
